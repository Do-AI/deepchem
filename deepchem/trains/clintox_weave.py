...
if __name__ == '__main__':
    tasks, datasets, transformers = dc.molnet.load_clintox(featurizer='Weave')
    train_dataset, valid_dataset, test_dataset = datasets

    hparams = load_hparams('/home/hanseok/deepchem_results/pretrained_models/clintoxweave/model.pickle')
    ...
    model = WeaveModel(
        ...
        mode='classification',
        model_dir='/home/hanseok/deepchem_results/clintoxweave/model'
    )
